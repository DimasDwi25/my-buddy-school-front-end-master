                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        ...
                                        margin: 0 auto;">
                                            ...
                                            padding-right: 15px;">
                                                ...
                                                color: #98999A;">All Course <span class="sr-only">(current)</span></a>
                                            </li>
                                            ...
                                            padding-right: 15px;">
                                                ...
                                                line-height: 22px;
                                                letter-spacing: -0.1px;
                                                color: #98999A;">Primary School (SD)</a>
                                            <li class="nav-item" style="
                                            padding-left: 15px;
                                            padding-right: 15px;">
                                                <a class="nav-link" href="#" style="
                                                ...
                                                line-height: 22px;
                                                letter-spacing: -0.1px;
                                                color: #98999A;">Junior High School (SMP)</a>
                                            <li class="nav-item" style="
                                            padding-left: 15px;
                                            padding-right: 15px;">
                                                <a class="nav-link" href="#" style="
                                                ...
                                                line-height: 22px;
                                                letter-spacing: -0.1px;
                                                color: #98999A;">Senior High School (SMA)</a>
                                            <li class="nav-item" style="
                                            padding-left: 15px;
                                            padding-right: 15px;">
                                                <a class="nav-link" href="#" style="
                                                ...
                                                line-height: 22px;
                                                letter-spacing: -0.1px;
                                                color: #98999A;">Higher School (PT)</a>
                                            </li>
                                            <li class="nav-item" style="
                                            padding-left: 15px;
                                            padding-right: 15px;">
